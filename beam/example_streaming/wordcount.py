...
from apache_beam.transforms.trigger import AccumulationMode, AfterCount, AfterWatermark, Repeatedly, OrFinally
...
def find_words(element):
  import re
  return re.findall(r'[A-Za-z\']+', element.decode('utf-8'))
